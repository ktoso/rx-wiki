...
* [**`generate( )` and `generateAbsoluteTime( )`**](Creating-Observables#wiki-generate-and-generateabsolutetime) — create an Observable that emits a sequence of items as generated by a function of your choosing
