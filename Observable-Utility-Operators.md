...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/materialize.png" width="640" height="315" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/dematerialize.png" width="640" height="335" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/timestamp.png" width="640" height="310" />​

The `timestamp( )` method converts an Observable that emits items of type _T_ into one that emits objects of type [`Timestamped<T>`](http://reactivex.io/RxJava/javadoc/rx/util/Timestamped.html), where each such object is stamped with the time at which it was emitted.
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/cache.png" width="640" height="410" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/observeOn.png" width="640" height="308" />​
...
* javadoc: <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#observeOn(rx.Scheduler)">`observeOn(scheduler)`</a>
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/subscribeOn.png" width="640" height="305" />​
...
#### see also:
* <a href="http://www.grahamlea.com/2014/07/rxjava-threading-examples/">RxJava Threading Examples</a> by Graham Lea
* javadoc: <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#subscribeOn(rx.Scheduler)">`subscribeOn(scheduler)`</a>
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/doOnEach.png" width="640" height="310" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/doOnCompleted.png" width="640" height="305" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/doOnError.png" width="640" height="305" />​
...
* javadoc: <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#doOnTerminate(rx.functions.Action0)">`doOnTerminate(action)`</a>
* Linq: <a href="http://msdn.microsoft.com/en-us/library/system.reactive.linq.observable.do.aspx">`Do`</a>
* RxJS: <a href="https://github.com/Reactive-Extensions/RxJS/blob/master/doc/api/core/observable.md#rxobservableprototypedoobserver--onnext-onerror-oncompleted">`do` and `doAction`</a>
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/doOnSubscribe.png" width="640" height="390" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/finallyDo.png" width="640" height="310" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/delay.png" width="640" height="310" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/delaySubscription.png" width="640" height="310" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/single.png" width="640" height="315" />​
...
<img src="/ReactiveX/RxJava/wiki/images/rx-operators/single.p.png" width="640" height="315" />​
...
* javadoc: <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#single()">`single( )`</a> and <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#single(rx.functions.Func1)">`single(predicate)`</a>
* javadoc: <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#singleOrDefault(T)">`singleOrDefault(default)`</a> and <a href="http://reactivex.io/RxJava/javadoc/rx/Observable.html#singleOrDefault(T, rx.functions.Func1)">`singleOrDefault(default,predicate)`</a>
