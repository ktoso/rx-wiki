...
A composable Future could be implemented just as generically, but Akka Futures for example come tied in with an Actor library and a lot of other stuff (http://doc.akka.io/docs/akka/2.2.0/java.html). RxJava tries not to restrict you in this way. You can choose to implement your Observables using actors, thread-pools, event loops, non-blocking I/O, or whatever implementation suits your needs, your style, or your expertise.
